...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/christophethibault/IdeaProjects/TP_ParisTech_2017_2018_starter/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/christophethibault/IdeaProjects/TP_ParisTech_2017_2018_starter/prepared_trainingset")
